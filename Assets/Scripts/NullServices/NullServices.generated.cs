...
public static class NullServices
{
    ...
    public sealed class NullUnitActionTickService : IUnitActionTickService
    {
        ...
        public event Action OnUpdateActionTick { add { } remove { } }
    ...
    public sealed class NullCameraRig : ICameraRig
    {
        ...
        public event Action<int> OnChangeLookFloor { add { } remove { } }
    ...
    public sealed class NullBuildPlacementService : IBuildPlacementService
    {
        ...
        public event Action<E_SetupObjectOffsetChange> OnSelectedChanged { add { } remove { } }
        public event Action<BuildPlacedEventArgs> OnPlaced { add { } remove { } }
        public event Action OnCanceled { add { } remove { } }
        public event Action<E_SetupObjectOffsetChange> OnRotated { add { } remove { } }
    ...
    public sealed class NullCursorEvents : ICursorEvents
    {
        ...
        public event Action<ValueTuple<GridPosition, GridPosition>> OnMousePositionChanged { add { } remove { } }
