...
public class Pathfinding : MonoBehaviour//, IPathfinder
{
    ...
    private void Setup()
    {
        ...
        floorAmount = GameConfig.Grid.FloorAmount;
        ...
        //            Vector3 worldPosition = Managers.Grid.GetWorldPosition(gridPosition);
        //            float raycastOffsetDistance = 1f;

        //            Managers.Grid.RequestCell(gridPosition, null, E_GridCheckType2.Void);
        ...
        //            {
        //                Managers.Grid.RequestCell(gridPosition, null, E_GridCheckType2.Walkable);
        //            }
        ...
        //            {
        //                Managers.Grid.RequestCell(gridPosition, null, E_GridCheckType2.Obstacle);
        //            }
        //        }
        //    }
        //}
    ...
    public List<GridPosition> FindPath
        ...
        out int pathLength,
        params E_GridCheckType2[] ignoreGridtype)
    {
        ...
        while (openList.Count > 0)
        {
            ...
            foreach (PathNode neighbourNode in GetNeighbourList(currentNode))
            {
                ...
                var cellType = Managers.Grid.GetTerrainType(neighbourNode.GetGridPosition());
                var cellEntity = Managers.Grid.GetUnitAt(neighbourNode.GetGridPosition());

                //// 1) Walkable이면 바로 통과
                //if (cellType == E_GridCheckType2.Walkable)
                //{
                //    // pass
                //}
                //else
                ...
                //    // 3) Reserve 추가 예외
                //    if (cellType == E_GridCheckType2.Reserve)
                //    {
                //        var startEntity = Managers.Grid.GetUnitAt(startGridPosition);
    ...
    public int GetPathLength(GridPosition startGridPosition, GridPosition endGridPosition, params E_GridCheckType2[] ignoreGridtype)
    {
        ...
        bool allowApproachWhenUnreachable = false)
    {
        ...
        foreach (var tgt in gridPositions)
        {
            ...
            while (stopIndex >= 0)
            {
                ...
                bool valid =
                    Managers.Grid.IsWalkableTerrain(stopPos);
