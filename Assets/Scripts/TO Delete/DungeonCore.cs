...
public class DungeonCore : PassiveObject, IDungeonCore
{
    ...
    protected override void HandleDamaged(OnAttackInfoEventArgs e)
    {
        base.HandleDamaged(e);
        ...
        // Shake Camera
        Managers.SceneServices.CameraShakeSettings.SetImpulseReactionDuration(timeintensity);
        m_CMImpulseSource?.GenerateImpulse(forceintensity);
    }

    protected override void HandleDead(OnAttackInfoEventArgs e)
    {
        base.HandleDead(e);
