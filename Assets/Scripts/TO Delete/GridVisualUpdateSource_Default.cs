...
public class GridVisualUpdateSource_Default : MonoBehaviour//, IGridVisualUpdateSource
{
    ...
    public bool IsPlacing => true;//Managers.Building?.Current != null;
    ...
    private void Start()
    {
        ...
        //_cursor.OnMousePositionChanged += HandleMousePositionChanged;

        //if (Managers.Building != null)
        //{
        //    Managers.Building.OnSelected += HandleBuildDirty;
        //    Managers.Building.OnRotated += HandleBuildDirty;
        //    Managers.Building.OnPlaced += HandleBuildDirty;
        //    Managers.Building.OnCanceled += HandleBuildDirty;
        //}
    ...
    // ✅ CommandManager: Action<OnCommandActionEventArgs>
    private void HandleSelectedActionChanged(CommandManager.OnCommandActionEventArgs e)
    {
    ...
    private void HandleLookFloorChanged(int floor)
    {
        CurrentFloor = floor;
        DrawGridVisual();
    }

    // ✅ MouseWorld: Action<(oldgp, newgp)>
    private void HandleMousePositionChanged(GridPosition oldgp, GridPosition newgp)
    {
        MouseGridPosition = newgp;
        DrawGridVisual();
    }

    // Build 이벤트들
    private void HandleBuildDirty() => DrawGridVisual();
    private void HandleBuildDirty(E_SetupObjectOffsetChange e) => DrawGridVisual();
    private void HandleBuildDirty(GridPosition e) => DrawGridVisual();
    ...
    private void RefreshCursorState()
    {
        ...
        MouseGridPosition = Util.Mouse.GetMouseWorldGridPosition();
    }
