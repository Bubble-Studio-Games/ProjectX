...
{
    public WeaponHolderSlot m_LeftHandSlot { get; private set; }
    public WeaponHolderSlot m_RightHandSlot { get; private set; }
    public WeaponHolderSlot backSlot { get; private set; }
    ...
    public bool isTwoHandingWeapon { get; private set; }
    public bool isUsingRightHand { get; private set; }
    public bool isUsingLeftHand { get; private set; }

    public LeftHandIKTarget leftHandIKTarget { get; private set; }
    public RightHandIKTarget rightHandIKTarget { get; private set; }
