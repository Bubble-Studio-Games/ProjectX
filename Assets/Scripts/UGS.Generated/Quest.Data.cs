...
namespace Quest
{
    ...
    { 
        ...
        static string spreadSheetID = "1ZdoUl0eLPzaGCgpvM34JEosc3GZRpBNjNfZvavGwcBc"; // it is file id
...
/* Fields. */
		...
		public System.String Quest_ID;
		public System.String Quest_Type;
		public System.String Quest_Name;
		public System.String Quest_Description;
		public System.String Quest_Goal_Type;
		public System.String Quest_Goal_Target;
		public System.Int32 Quest_Goal_Count;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("Quest"); 
            if (text != null)
            {
          ...
          // 실제 데이터 로드
                    if (rows.Count != 0)
                    {
                        ...
                        for (int i = 0; i < rowCount; i++)
                        {
                            ...
                            List.Add(instance); 
                            Map.Add(instance.Quest_ID, instance);
                        }
